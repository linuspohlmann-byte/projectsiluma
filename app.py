...
def api_get_available_courses():
    ...
    try:
        ...
        courses = [
            ...
            {'code': 'da', 'name': 'Dansk', 'english_name': 'Danish'},
            {'code': 'no', 'name': 'Norsk', 'english_name': 'Norwegian'},
            {'code': 'fi', 'name': 'Suomi', 'english_name': 'Finnish'},
            {'code': 'is', 'name': 'Íslenska', 'english_name': 'Icelandic'},
            {'code': 'ka', 'name': 'ქართული', 'english_name': 'Georgian'},
            {'code': 'sr', 'name': 'Српски', 'english_name': 'Serbian'},
            {'code': 'sw', 'name': 'Kiswahili', 'english_name': 'Swahili'},
            {'code': 'fa', 'name': 'فارسی', 'english_name': 'Persian'},
            {'code': 'th', 'name': 'ไทย', 'english_name': 'Thai'},
            {'code': 'vi', 'name': 'Tiếng Việt', 'english_name': 'Vietnamese'},
            {'code': 'id', 'name': 'Bahasa Indonesia', 'english_name': 'Indonesian'},
            ...
            {'code': 'ro', 'name': 'Română', 'english_name': 'Romanian'},
            {'code': 'hu', 'name': 'Magyar', 'english_name': 'Hungarian'},
